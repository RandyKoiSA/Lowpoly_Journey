...
def ImportAllAssets():
	...
	def CreateTask_SK_BasicHelmet():
		################[ Import BasicHelmet as SkeletalMesh type ]################
		print('================[ New import task : BasicHelmet as SkeletalMesh type ]================')
		FilePath = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\UEFY2.0 - Armor Assets\ExportedFbx\SkeletalMesh\BasicHelmet\SK_BasicHelmet.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\UEFY2.0 - Armor Assets\ExportedFbx\SkeletalMesh\BasicHelmet\SK_BasicHelmet_AdditionalParameter.ini')
		...
		print('================[ import asset : BasicHelmet ]================')
		...
		if len(task.imported_object_paths) > 0:
			...
			asset = None
		if asset == None:
			ImportFailList.append('Asset "BasicHelmet" not found for after inport')
			return
		print('========================= Imports of BasicHelmet completed ! Post treatment started...	=========================')
		...
		for x, lod in enumerate(lods_to_add):
			pass
		print('========================= Post treatment of BasicHelmet completed !	 =========================')
		unreal.EditorAssetLibrary.save_loaded_asset(asset)
		ImportedList.append([asset, 'SkeletalMesh'])
	CreateTask_SK_BasicHelmet()
