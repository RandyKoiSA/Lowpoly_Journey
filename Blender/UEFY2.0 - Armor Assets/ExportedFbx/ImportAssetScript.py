...
def ImportAllAssets():
	...
	def CreateTask_SK_BasicFoot():
		################[ Import BasicFoot as SkeletalMesh type ]################
		print('================[ New import task : BasicFoot as SkeletalMesh type ]================')
		FilePath = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\UEFY2.0 - Armor Assets\ExportedFbx\SkeletalMesh\BasicFoot\SK_BasicFoot.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\UEFY2.0 - Armor Assets\ExportedFbx\SkeletalMesh\BasicFoot\SK_BasicFoot_AdditionalParameter.ini')
		...
		if len(task.imported_object_paths) > 0:
			...
			asset = None
		if asset == None:
			ImportFailList.append('Asset "BasicFoot" not found for after inport')
			return
		print('========================= Imports of BasicFoot completed ! Post treatment started...	=========================')
		...
		for x, lod in enumerate(lods_to_add):
			pass
		print('========================= Post treatment of BasicFoot completed !	 =========================')
		unreal.EditorAssetLibrary.save_loaded_asset(asset)
		ImportedList.append([asset, 'SkeletalMesh'])
	CreateTask_SK_BasicFoot()
