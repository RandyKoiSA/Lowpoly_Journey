...
#Use this command : py "D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\ExportedFbx\ImportAssetScript.py"
...
def ImportAllAssets():
	...
	def CreateTask_SM_LegModule001():
		...
		print('================[ New import task : LegModule.001 as StaticMesh type ]================')
		FilePath = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\ExportedFbx\StaticMesh\SM_LegModule001.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\ExportedFbx\StaticMesh\SM_LegModule.001_AdditionalParameter.ini')
		...
		print('================[ import asset : LegModule.001 ]================')
		...
		if len(task.imported_object_paths) > 0:
			...
			asset = None
		if asset == None:
			ImportFailList.append('Asset "LegModule.001" not found for after inport')
			return
		print('========================= Imports of LegModule.001 completed ! Post treatment started...	=========================')
		...
		print('========================= Post treatment of LegModule.001 completed !	 =========================')
		unreal.EditorAssetLibrary.save_loaded_asset(asset)
		ImportedList.append([asset, 'StaticMesh'])
	CreateTask_SM_LegModule001()
	...
	def CreateTask_SK_LegModule():
		################[ Import LegModule as SkeletalMesh type ]################
		print('================[ New import task : LegModule as SkeletalMesh type ]================')
		FilePath = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\ExportedFbx\SkeletalMesh\LegModule\SK_LegModule.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\ExportedFbx\SkeletalMesh\LegModule\SK_LegModule_AdditionalParameter.ini')
		AssetImportPath = (os.path.join(unrealImportLocation, r'').replace('\\','/')).rstrip('/')
		task = unreal.AssetImportTask()
		task.filename = FilePath
		task.destination_path = AssetImportPath
		...
		if len(task.imported_object_paths) > 0:
			...
			asset = None
		if asset == None:
			ImportFailList.append('Asset "LegModule" not found for after inport')
			return
		print('========================= Imports of LegModule completed ! Post treatment started...	=========================')
		...
		for x, lod in enumerate(lods_to_add):
			pass
		print('========================= Post treatment of LegModule completed !	 =========================')
		unreal.EditorAssetLibrary.save_loaded_asset(asset)
		ImportedList.append([asset, 'SkeletalMesh'])
	CreateTask_SK_LegModule()
