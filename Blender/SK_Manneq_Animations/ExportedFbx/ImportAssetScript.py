...
#Use this command : py "D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\SK_Manneq_Animations\ExportedFbx\ImportAssetScript.py"
...
def ImportAllAssets():
	...
	def CreateTask_SK_Mannequin():
		################[ Import Mannequin as SkeletalMesh type ]################
		print('================[ New import task : Mannequin as SkeletalMesh type ]================')
		FilePath = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\SK_Manneq_Animations\ExportedFbx\SkeletalMesh\Mannequin\SK_Mannequin.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Users\97ran\Documents\Unreal Projects\Lowpoly_Journey\Blender\SK_Manneq_Animations\ExportedFbx\SkeletalMesh\Mannequin\SK_Mannequin_AdditionalParameter.ini')
		...
		if len(task.imported_object_paths) > 0:
			...
			asset = None
		if asset == None:
			ImportFailList.append('Asset "Mannequin" not found for after inport')
			return
		print('========================= Imports of Mannequin completed ! Post treatment started...	=========================')
		...
		for x, lod in enumerate(lods_to_add):
			pass
		print('========================= Post treatment of Mannequin completed !	 =========================')
		unreal.EditorAssetLibrary.save_loaded_asset(asset)
		ImportedList.append([asset, 'SkeletalMesh'])
	CreateTask_SK_Mannequin()
